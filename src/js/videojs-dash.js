    ...
    setupQualityLevels_() {
        ...
        if (player && player.qualityLevels) {
            ...
            this.mediaPlayer_.on(dashjs.MediaPlayer.events.PLAYBACK_METADATA_LOADED, () => {
                ...
                this.videoRates_.forEach((vrate) => {
            ...
            this.qualityLevels_.on('change', (event) => {
                ...
                if (enabledQualities.length === 1) {
                    if (autoSwitchingEnabled.video) {
                        this.mediaPlayer_.updateSettings({ 'streaming': { 'abr': { 'autoSwitchBitrate': { 'video': false, 'audio': false } } } });
                    }
                    ...
                    this.mediaPlayer_.updateSettings({ 'streaming': { 'abr': { 'autoSwitchBitrate': { 'video': true, 'audio': true } } } });
                }
